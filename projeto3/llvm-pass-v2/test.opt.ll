...
entry0:
  ...
  %tmp3 = bitcast %class.Tree* %tmp0 to %class.Tree*
...
entry0:
  ...
  store %class.Tree* %rn, %class.Tree** %tmp1
  ret i1 true
}
...
entry0:
  ...
  store %class.Tree* %ln, %class.Tree** %tmp1
  ret i1 true
}
